...
def combine_all_data(ord_1, ord_2):
    ...
    :return:
    """
    df_1 = pd.read_csv(f'{DATA_HOME_PATH}/IO_PRICINGPARAMETER_{ord_1}.csv', parse_dates=['TradingDate'])
    df_2 = pd.read_csv(f'{DATA_HOME_PATH}/IO_QUOTATIONBAS_{ord_1}.csv', parse_dates=['TradingDate'])
    df_3 = pd.read_csv(f'{DATA_HOME_PATH}/IO_QUOTATIONDER_{ord_1}.csv', parse_dates=['TradingDate'])
    # df_4 = pd.read_csv(f'{DATA_HOME_PATH}/BND_Exchange.csv', parse_dates=['Clsdt'])
    ...
    #         prev_d_data = df[df['TradingDate'] == prev_date].iloc[0]
    #         d_data['date'] = i
    #         d_data['rate_1'] = prev_d_data['rate_1']
    #         d_data['rate_2'] = prev_d_data['rate_2']
    #         d_data['rate_3'] = prev_d_data['rate_3']
    #         d_data['rate_7'] = prev_d_data['rate_7']
    #         d_data['rate_14'] = prev_d_data['rate_14']
    #         d_data['rate_21'] = prev_d_data['rate_21']
